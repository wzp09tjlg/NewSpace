 ...
 */
public class NewsFragment extends MvpFragment<FragmentNewsBinding,FunPresenter> implements View.OnClickListener, FunView {
    ...
    protected void initView() {
        ...
        binding.pagesNews.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if(position == 0){
                    mCurrentIndex = 0;
                    binding.layoutSort.textArea.setChecked(true);
                }else if(position == 1){
                    mCurrentIndex = 1;
                    binding.layoutSort.textDynamic.setChecked(true);
                }
            }

            @Override
            public void onPageScrollStateChanged(int state){
                binding.layoutSort.textArea.setClickable(state == 0);
                binding.layoutSort.textDynamic.setClickable(state == 0);
            }
        });
    }
    ...
    protected void initData() {
        ...
        binding.layoutSort.textArea.setOnClickListener(this);
        binding.layoutSort.textDynamic.setOnClickListener(this);
